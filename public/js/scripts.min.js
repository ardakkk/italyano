...
$(document).ready(function () {
	...
	// 		var rname = document.getElementsByClassName('remodal-name')[0];
	// 		if (oname.length !== 0) {
	// 			rname.innerText = oname + ',';
	// 		}
	...
	// 		});
	// 	} else {
	// 		var content = document.getElementsByClassName('remodal-content')[0];
	// 		content.innerHTML = '<h1>Не выбрано!</h1>';
	// 	}
	// });
	...
	signin.click(function(){
		...
		$.ajax({
			type: 'POST',
			url: '/user/signin',
			data: { email: login, password: pwd, _token: token },
			dataType: 'JSON',
			success: function (res) {
...
if(localStorage.getItem('OrderAuthStatus') === 'true'){
	var authOrderTotal = localStorage.getItem('totalPrice');
	$('[data-remodal-id=auth-order]').remodal().open();
	document.getElementsByClassName('auth-order__total')[0].innerHTML = '<b>Итого: </b>' + authOrderTotal + 'тг';
...
// 			totalPrice !== 0 ? this.total = totalPrice : 0;
// 			return this.total;
// 		}
// 	}
// });
