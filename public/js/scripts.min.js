		...
		Array.from(check).forEach(function (btn) {
			btn.addEventListener('click', function (e) {
				if (e.target.className === 'count__submit pizza-btn' && btn.parentElement.parentElement.previousElementSibling.getElementsByClassName('active-btn')[0]) {
					...
					hideCountBtn(btn);
					totalPrice();
					document.getElementsByClassName('tab-inner__orders')[0].getElementsByTagName('ul')[0].innerHTML = '';
					tabItem();
					...
					hideCountBtn(btn);
					totalPrice();
					document.getElementsByClassName('tab-inner__orders')[0].getElementsByTagName('ul')[0] = '';
					tabItem();
				} else {
